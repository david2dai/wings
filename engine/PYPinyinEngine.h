...
public:
    ...
    // David
    void focusedRecWord (IBusText *sel_rec_word);
    void focusedRecSentence (IBusText *sel_rec_sentence);

    void pageUpRecWords (void);
    void pageDownRecWords (void);
    void cursorUpRecWords  (void);
    void cursorDownRecWords  (void);
    void candidateClickedRecWords  (guint index, guint button, guint state);
    
    void pageUpRecSentences (void);
    void pageDownRecSentences (void);
    void cursorUpRecSentences  (void);
    void cursorDownRecSentences  (void);
    void candidateClickedRecSentences  (guint index, guint button, guint state);
...
private:
    ...
    //String m_focused_rec_word;
    //String m_focused_rec_sentence;
