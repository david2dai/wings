...
class IPanel(dbus.service.Object):
    ...
    # David
    @method(in_signature="vb")
    def UpdateLookupTableRecWords(self, lookup_table, visible): pass

    @method()
    def ShowLookupTableRecWords(self): pass

    @method()
    def HideLookupTableRecWords(self): pass
    
    @method(in_signature="vb")
    def UpdateLookupTableRecSentences(self, lookup_table, visible): pass

    @method()
    def ShowLookupTableRecSentences(self): pass

    @method()
    def HideLookupTableRecSentences(self): pass
    ...
    def UpdateFocusedAreaIndicator(self, indicator): pass
    ...
    # For rec wrods
    @signal()
    def PageUpRecWords(self): pass

    @signal()
    def PageDownRecWords(self): pass

    @signal()
    def CursorUpRecWords(self): pass

    @signal()
    def CursorDownRecWords(self): pass
    
    @signal(signature="uuu")
    def CandidateClickedRecWords(self, index, button, state): pass

    # For rec sentences 
    @signal()
    def PageUpRecSentences(self): pass

    @signal()
    def PageDownRecSentences(self): pass

    @signal()
    def CursorUpRecSentences(self): pass

    @signal()
    def CursorDownRecSentences(self): pass
    
    @signal(signature="uuu")
    def CandidateClickedRecSentences(self, index, button, state): pass
    ...
    # David
    @signal(signature="v")
    def FocusedRecWord(self, sel_rec_word): pass
    
    @signal(signature="v")
    def FocusedRecSentence(self, sel_rec_sentence): pass
