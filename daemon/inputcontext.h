...
// David
// Add for rec words
// cursor up/down page up/down candidate click
/**
 * bus_input_context_page_up_rec_words:
 *
 * Call page_up method of the current engine proxy.
 */
void                 bus_input_context_page_up_rec_words (BusInputContext    *context);

/**
 * bus_input_context_page_down_rec_words:
 *
 * Call page_down method of the current engine proxy.
 */
void                 bus_input_context_page_down_rec_words (BusInputContext    *context);

/**
 * bus_input_context_cursor_up_rec_words:
 *
 * Call cursor_up method of the current engine proxy.
 */
void                 bus_input_context_cursor_up_rec_words (BusInputContext    *context);

/**
 * bus_input_context_cursor_down_rec_words:
 *
 * Call cursor_down method of the current engine proxy.
 */
void                 bus_input_context_cursor_down_rec_words (BusInputContext    *context);

/**
 * bus_input_context_candidate_clicked_rec_words:
 *
 * Call candidate_clicked method of the current engine proxy.
 */
void                 bus_input_context_candidate_clicked_rec_words (BusInputContext    *context,
                                                         guint               index,
                                                         guint               button,
                                                         guint               state);
...
// cursor up/down page up/down candidate click
/**
 * bus_input_context_page_up_rec_sentences:
 *
 * Call page_up method of the current engine proxy.
 */
void                 bus_input_context_page_up_rec_sentences (BusInputContext    *context);

/**
 * bus_input_context_page_down_rec_sentences:
 *
 * Call page_down method of the current engine proxy.
 */
void                 bus_input_context_page_down_rec_sentences (BusInputContext    *context);

/**
 * bus_input_context_cursor_up_rec_sentences:
 *
 * Call cursor_up method of the current engine proxy.
 */
void                 bus_input_context_cursor_up_rec_sentences (BusInputContext    *context);

/**
 * bus_input_context_cursor_down_rec_sentences:
 *
 * Call cursor_down method of the current engine proxy.
 */
void                 bus_input_context_cursor_down_rec_sentences (BusInputContext    *context);

/**
 * bus_input_context_candidate_clicked_rec_sentences:
 *
 * Call candidate_clicked method of the current engine proxy.
 */
void                 bus_input_context_candidate_clicked_rec_sentences (BusInputContext    *context,
                                                         guint               index,
                                                         guint               button,
                                                         guint               state);
...
// David
/**
 * bus_input_context_focused_rec_word:
 *
 * Call focused_rec_word method of the current engine proxy.
 */
void                 bus_input_context_focused_rec_word (BusInputContext    *context,
                                                         IBusText           *sel_rec_word);

/**
 * bus_input_context_focused_rec_sentence:
 *
 * Call focused_rec_sentence method of the current engine proxy.
 */
void                 bus_input_context_focused_rec_sentence (BusInputContext    *context,
