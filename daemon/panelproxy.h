...
// David
void             bus_panel_proxy_update_focused_area_indicator(BusPanelProxy *panel,
                                                               guint         indicator);
...
void             bus_panel_proxy_update_lookup_table_rec_words (BusPanelProxy      *panel,
                                                     IBusLookupTable    *table,
                                                     gboolean           visible);
void             bus_panel_proxy_update_lookup_table_rec_sentences (BusPanelProxy      *panel,
                                                     IBusLookupTable    *table,
                                                     gboolean           visible);

void             bus_panel_proxy_show_lookup_table  (BusPanelProxy      *panel);
void             bus_panel_proxy_hide_lookup_table  (BusPanelProxy      *panel);
void             bus_panel_proxy_show_lookup_table_rec_words  (BusPanelProxy      *panel);
void             bus_panel_proxy_hide_lookup_table_rec_words  (BusPanelProxy      *panel);
void             bus_panel_proxy_show_lookup_table_rec_sentences (BusPanelProxy      *panel);
void             bus_panel_proxy_hide_lookup_table_rec_sentences (BusPanelProxy      *panel);
