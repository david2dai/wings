...
// candidate click
/**
 * bus_engine_proxy_page_up_rec_words:
 *
 * Call "PageUp" method of an engine asynchronously.
 */
void             bus_engine_proxy_page_up_rec_words           (BusEngineProxy        *engine);

/**
 * bus_engine_proxy_page_down_rec_words:
 *
 * Call "PageDown" method of an engine asynchronously.
 */
void             bus_engine_proxy_page_down_rec_words         (BusEngineProxy        *engine);

/**
 * bus_engine_proxy_cursor_up_rec_words:
 *
 * Call "CursorUp" method of an engine asynchronously.
 */
void             bus_engine_proxy_cursor_up_rec_words         (BusEngineProxy        *engine);

/**
 * bus_engine_proxy_cursor_down_rec_words:
 *
 * Call "CursorDown" method of an engine asynchronously.
 */
void             bus_engine_proxy_cursor_down_rec_words       (BusEngineProxy        *engine);

/**
 * bus_engine_proxy_candidate_clicked_rec_words:
 *
 * Call "CandidateClicked" method of an engine asynchronously.
 */
void             bus_engine_proxy_candidate_clicked_rec_words (BusEngineProxy        *engine,
                                                     guint                  index,
                                                     guint                  button,
                                                     guint                  state);
...
// candidate click
/**
 * bus_engine_proxy_page_up_rec_sentences:
 *
 * Call "PageUp" method of an engine asynchronously.
 */
void             bus_engine_proxy_page_up_rec_sentences         (BusEngineProxy        *engine);

/**
 * bus_engine_proxy_page_down_rec_sentences:
 *
 * Call "PageDown" method of an engine asynchronously.
 */
void             bus_engine_proxy_page_down_rec_sentences (BusEngineProxy        *engine);

/**
 * bus_engine_proxy_cursor_up_rec_sentences:
 *
 * Call "CursorUp" method of an engine asynchronously.
 */
void             bus_engine_proxy_cursor_up_rec_sentences (BusEngineProxy        *engine);

/**
 * bus_engine_proxy_cursor_down_rec_sentences:
 *
 * Call "CursorDown" method of an engine asynchronously.
 */
void             bus_engine_proxy_cursor_down_rec_sentences (BusEngineProxy        *engine);

/**
 * bus_engine_proxy_candidate_clicked_rec_sentences:
 *
 * Call "CandidateClicked" method of an engine asynchronously.
 */
void             bus_engine_proxy_candidate_clicked_rec_sentences (BusEngineProxy        *engine,
                                                     guint                  index,
                                                     guint                  button,
                                                     guint                  state);
 ...
 *
 * Call "FocusedRecWord" method of an engine asynchronously.
 */
void             bus_engine_proxy_focused_rec_word (BusEngineProxy        *engine,
                                                     IBusText              *sel_rec_word);

/**
 * bus_input_context_focused_rec_sentence:
 *
 * Call "FocusedRecSentence" method of an engine asynchronously.
 */
void             bus_engine_proxy_focused_rec_sentence (BusEngineProxy        *engine,
