...
enum {
    ...
    PAGE_DOWN_REC_WORDS,
    CURSOR_UP_REC_WORDS,
    CURSOR_DOWN_REC_WORDS,
    CANDIDATE_CLICKED_REC_WORDS,
    // for rec sentences
    PAGE_UP_REC_SENTENCES,
    PAGE_DOWN_REC_SENTENCES,
    CURSOR_UP_REC_SENTENCES,
    CURSOR_DOWN_REC_SENTENCES,
    CANDIDATE_CLICKED_REC_SENTENCES,
    // end
    PROPERTY_ACTIVATE,
    PROPERTY_SHOW,
    PROPERTY_HIDE,
    FOCUSED_REC_WORD,
    FOCUSED_REC_SENTENCE,
    LAST_SIGNAL,
};
...
struct _BusPanelProxyClass {
    ...
    void (* page_up_rec_words)            (BusPanelProxy   *panel);
    void (* page_down_rec_words)          (BusPanelProxy   *panel);
    void (* cursor_up_rec_words)          (BusPanelProxy   *panel);
    void (* cursor_down_rec_words)        (BusPanelProxy   *panel);
    void (* candidate_clicked_rec_words)  (BusPanelProxy   *panel,
                                 guint            index,
                                 guint            button,
                                 guint            state);

    void (* page_up_rec_sentences )            (BusPanelProxy   *panel);
    void (* page_down_rec_sentences )          (BusPanelProxy   *panel);
    void (* cursor_up_rec_sentences )          (BusPanelProxy   *panel);
    void (* cursor_down_rec_sentences )        (BusPanelProxy   *panel);
    void (* candidate_clicked_rec_sentences )  (BusPanelProxy   *panel,
                                 guint            index,
                                 guint            button,
                                 guint            state);
    ...
    // David
    void (* focused_rec_word)   (BusPanelProxy   *panel,
                                 IBusText        *sel_rec_word);

    void (* focused_rec_sentence)   (BusPanelProxy   *panel,
...
static void     bus_panel_proxy_candidate_clicked
                                                (BusPanelProxy          *panel,
                                                 ...
                                                 guint                   state);
// David
static void     bus_panel_proxy_focused_rec_word
                                                (BusPanelProxy          *panel,
                                                 IBusText               *sel_rec_word);
static void     bus_panel_proxy_focused_rec_sentence
                                                (BusPanelProxy          *panel,
                                                 IBusText               *sel_rec_sentence);
...
static void     bus_panel_proxy_page_up_rec_words                  (BusPanelProxy          *panel);
static void     bus_panel_proxy_page_down_rec_words                (BusPanelProxy          *panel);
static void     bus_panel_proxy_cursor_up_rec_words                (BusPanelProxy          *panel);
static void     bus_panel_proxy_cursor_down_rec_words              (BusPanelProxy          *panel);
static void     bus_panel_proxy_candidate_clicked_rec_words         
                                                                   (BusPanelProxy          *panel,
                                                 guint                   index,
                                                 guint                   button,
                                                 guint                   state);
static void     bus_panel_proxy_page_up_rec_sentences                 (BusPanelProxy          *panel);
static void     bus_panel_proxy_page_down_rec_sentences               (BusPanelProxy          *panel);
static void     bus_panel_proxy_cursor_up_rec_sentences               (BusPanelProxy          *panel);
static void     bus_panel_proxy_cursor_down_rec_sentences             (BusPanelProxy          *panel);
static void     bus_panel_proxy_candidate_clicked_rec_sentences                 
                                                                   (BusPanelProxy          *panel,
                                                 guint                   index,
                                                 guint                   button,
                                                 guint                   state);
...
bus_panel_proxy_class_init (BusPanelProxyClass *class)
{
    ...
    class->page_up_rec_words            = bus_panel_proxy_page_up_rec_words;
    class->page_down_rec_words          = bus_panel_proxy_page_down_rec_words;
    class->cursor_up_rec_words          = bus_panel_proxy_cursor_up_rec_words;
    class->cursor_down_rec_words        = bus_panel_proxy_cursor_down_rec_words;
    class->candidate_clicked_rec_words  = bus_panel_proxy_candidate_clicked_rec_words;

    class->page_up_rec_sentences            = bus_panel_proxy_page_up_rec_sentences;
    class->page_down_rec_sentences          = bus_panel_proxy_page_down_rec_sentences;
    class->cursor_up_rec_sentences          = bus_panel_proxy_cursor_up_rec_sentences;
    class->cursor_down_rec_sentences        = bus_panel_proxy_cursor_down_rec_sentences;
    class->candidate_clicked_rec_sentences  = bus_panel_proxy_candidate_clicked_rec_sentences;

    class->property_activate = bus_panel_proxy_property_activate;

    // David
    class->focused_rec_word     = bus_panel_proxy_focused_rec_word;
    class->focused_rec_sentence = bus_panel_proxy_focused_rec_sentence;
    ...
    // David 
    // For rec words
    panel_signals[PAGE_UP_REC_WORDS] =
        g_signal_new (I_("page-up-rec-words"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, page_up_rec_words),
            NULL, NULL,
            bus_marshal_VOID__VOID,
            G_TYPE_NONE, 0);

    panel_signals[PAGE_DOWN_REC_WORDS] =
        g_signal_new (I_("page-down-rec-words"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, page_down_rec_words),
            NULL, NULL,
            bus_marshal_VOID__VOID,
            G_TYPE_NONE, 0);

    panel_signals[CURSOR_UP_REC_WORDS] =
        g_signal_new (I_("cursor-up-rec-words"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, cursor_up_rec_words),
            NULL, NULL,
            bus_marshal_VOID__VOID,
            G_TYPE_NONE, 0);

    panel_signals[CURSOR_DOWN_REC_WORDS] =
        g_signal_new (I_("cursor-down-rec-words"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, cursor_down_rec_words),
            NULL, NULL,
            bus_marshal_VOID__VOID,
            G_TYPE_NONE, 0);

    panel_signals[CANDIDATE_CLICKED_REC_WORDS] =
        g_signal_new (I_("candidate-clicked-rec-words"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, candidate_clicked_rec_words),
            NULL, NULL,
            bus_marshal_VOID__UINT_UINT_UINT,
            G_TYPE_NONE, 3,
            G_TYPE_UINT,
    ...
    // For rec sentences 
    panel_signals[PAGE_UP_REC_SENTENCES] =
        g_signal_new (I_("page-up-rec-sentences"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, page_up_rec_sentences),
            NULL, NULL,
            bus_marshal_VOID__VOID,
            G_TYPE_NONE, 0);

    panel_signals[PAGE_DOWN_REC_SENTENCES] =
        g_signal_new (I_("page-down-rec-sentences"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, page_down_rec_sentences),
            NULL, NULL,
            bus_marshal_VOID__VOID,
            G_TYPE_NONE, 0);

    panel_signals[CURSOR_UP_REC_SENTENCES] =
        g_signal_new (I_("cursor-up-rec-sentences"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, cursor_up_rec_sentences),
            NULL, NULL,
            bus_marshal_VOID__VOID,
            G_TYPE_NONE, 0);

    panel_signals[CURSOR_DOWN_REC_SENTENCES] =
        g_signal_new (I_("cursor-down-rec-sentences"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, cursor_down_rec_sentences),
            NULL, NULL,
            bus_marshal_VOID__VOID,
            G_TYPE_NONE, 0);

    panel_signals[CANDIDATE_CLICKED_REC_SENTENCES] =
        g_signal_new (I_("candidate-clicked-rec-sentences"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            G_STRUCT_OFFSET(BusPanelProxyClass, candidate_clicked_rec_sentences),
            NULL, NULL,
            bus_marshal_VOID__UINT_UINT_UINT,
            G_TYPE_NONE, 3,
            G_TYPE_UINT,
    ...
    // David
    // install glib signal for rec word and rec sentence
    panel_signals[FOCUSED_REC_WORD] =
        g_signal_new (I_("focused-rec-word"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            //0,   // Method process this signal
            G_STRUCT_OFFSET(BusPanelProxyClass, focused_rec_word),
            NULL, NULL,
            bus_marshal_VOID__OBJECT, // Already defined in the marshalers.h
            G_TYPE_NONE, 
            1,
            IBUS_TYPE_TEXT);
    
    panel_signals[FOCUSED_REC_SENTENCE] =
        g_signal_new (I_("focused-rec-sentence"),
            G_TYPE_FROM_CLASS (class),
            G_SIGNAL_RUN_LAST,
            //0,   // Method process this signal
            G_STRUCT_OFFSET(BusPanelProxyClass, focused_rec_sentence),
            NULL, NULL,
            bus_marshal_VOID__OBJECT,  // Already defined in the marshalers.h
            G_TYPE_NONE, 
            1,
                          ...
                          GVariant    *parameters)
{
    ...
    static const struct {
        ...
        // David
        // For rec words
        { "PageUpRecWords",         PAGE_UP_REC_WORDS },
        { "PageDownRecWords",       PAGE_DOWN_REC_WORDS  },
        { "CursorUpRecWords",       CURSOR_UP_REC_WORDS  },
        { "CursorDownRecWords",     CURSOR_DOWN_REC_WORDS  },
        // For rec sentences
        { "PageUpRecSentences",         PAGE_UP_REC_SENTENCES },
        { "PageDownRecSentences",       PAGE_DOWN_REC_SENTENCES },
        { "CursorUpRecSentences",       CURSOR_UP_REC_SENTENCES },
        { "CursorDownRecSentences",     CURSOR_DOWN_REC_SENTENCES },
    };
    ...
    /* Handle D-Bus signals with parameters. Deserialize them and emit a glib signal. */
    if (g_strcmp0 ("CandidateClickedRecWords", signal_name) == 0) {
        guint index = 0;
        guint button = 0;
        guint state = 0;
        g_variant_get (parameters, "(uuu)", &index, &button, &state);
        g_signal_emit (panel, panel_signals[CANDIDATE_CLICKED_REC_WORDS], 0, index, button, state);
        return;
    }

    /* Handle D-Bus signals with parameters. Deserialize them and emit a glib signal. */
    if (g_strcmp0 ("CandidateClickedRecSentences", signal_name) == 0) {
        guint index = 0;
        guint button = 0;
        guint state = 0;
        g_variant_get (parameters, "(uuu)", &index, &button, &state);
        g_signal_emit (panel, panel_signals[CANDIDATE_CLICKED_REC_SENTENCES], 0, index, button, state);
        return;
    }
    ...
    // David
    // process the bus signal panel
    if (g_strcmp0 ("FocusedRecWord", signal_name) == 0) {
        GVariant *arg0 = NULL;

        g_variant_get (parameters, "(v)", &arg0);
        g_return_if_fail (arg0 != NULL);

        IBusText *sel_rec_word = IBUS_TEXT (ibus_serializable_deserialize (arg0));
        g_variant_unref (arg0);
        g_return_if_fail (sel_rec_word != NULL);

        g_signal_emit (panel, panel_signals[FOCUSED_REC_WORD], 0, sel_rec_word);

        // David 
        // When the glib signal got processed, will execute the following.
        // And then unref the sel_rec_word object
        //
        // About g_object_unref: Decreases the reference count of object. 
        // When its reference count drops to 0, the object is finalized 
        // (i.e. its memory is freed).
        //
        // About g_object_ref_sink: Increase the reference count of object, and possibly remove the floating reference, 
        // if object has a floating reference.
        // In other words, if the object is floating, 
        // then this call "assumes ownership" of the floating reference, 
        // converting it to a normal reference by clearing the floating 
        // flag while leaving the reference count unchanged. 
        // If the object is not floating, then this call adds a new normal 
        // reference increasing the reference count by one. 
        
        // Original 
        // _g_object_unref_if_floating (sel_rec_word);
   
        // David
        // _g_object_unref_if_floating  is equal to the following two line
        if (g_object_is_floating (sel_rec_word))
        {
            g_object_unref (sel_rec_word);
    ...
    if (g_strcmp0 ("FocusedRecSentence", signal_name) == 0) {
        GVariant *arg0 = NULL;

        g_variant_get (parameters, "(v)", &arg0);
        g_return_if_fail (arg0 != NULL);

        IBusText *sel_rec_sentence = IBUS_TEXT (ibus_serializable_deserialize (arg0));
        g_variant_unref (arg0);
        g_return_if_fail (sel_rec_sentence != NULL);

        g_signal_emit (panel, panel_signals[FOCUSED_REC_SENTENCE], 0, sel_rec_sentence);

        if (g_object_is_floating (sel_rec_sentence))
        {
            g_object_unref (sel_rec_sentence);

        }

        //_g_object_unref_if_floating (sel_rec_sentence);
...
// David
void
bus_panel_proxy_update_focused_area_indicator(BusPanelProxy *panel,
                                              guint         indicator)
{
    g_assert (BUS_IS_PANEL_PROXY (panel));
...
void
bus_panel_proxy_update_lookup_table_rec_words (BusPanelProxy   *panel,
                                     IBusLookupTable *table,
                                     gboolean         visible)
{
    g_assert (BUS_IS_PANEL_PROXY (panel));
...
void
bus_panel_proxy_update_lookup_table_rec_sentences (BusPanelProxy   *panel,
                                     IBusLookupTable *table,
                                     gboolean         visible)
{
...
// David
DEFINE_FUNC(page_up_rec_words)
DEFINE_FUNC(page_down_rec_words)
DEFINE_FUNC(cursor_up_rec_words)
DEFINE_FUNC(cursor_down_rec_words)

DEFINE_FUNC(page_up_rec_sentences)
DEFINE_FUNC(page_down_rec_sentences)
DEFINE_FUNC(cursor_up_rec_sentences)
DEFINE_FUNC(cursor_down_rec_sentences)
#undef DEFINE_FUNC

// David
static void
bus_panel_proxy_focused_rec_word (BusPanelProxy          *panel,
                                  IBusText               *sel_rec_word)
{
    g_assert (BUS_IS_PANEL_PROXY (panel));

    if (panel->focused_context) {
        bus_input_context_focused_rec_word (panel->focused_context,
                                             sel_rec_word);
    }
...
static void
bus_panel_proxy_focused_rec_sentence (BusPanelProxy          *panel,
                                      IBusText               *sel_rec_sentence)
{
    g_assert (BUS_IS_PANEL_PROXY (panel));

    if (panel->focused_context) {
        bus_input_context_focused_rec_sentence (panel->focused_context,
                                             sel_rec_sentence);
    }
...
// David
static void
bus_panel_proxy_candidate_clicked_rec_words (BusPanelProxy *panel,
                                   guint          index,
                                   guint          button,
                                   guint          state)
{
    ...
    if (panel->focused_context) {
        bus_input_context_candidate_clicked_rec_words (panel->focused_context,
                                             index,
                                             button,
                                             state);
...
// David
static void
bus_panel_proxy_candidate_clicked_rec_sentences (BusPanelProxy *panel,
                                   guint          index,
                                   guint          button,
                                   guint          state)
{
    ...
    if (panel->focused_context) {
        bus_input_context_candidate_clicked_rec_sentences (panel->focused_context,
                                             index,
                                             button,
                                             state);
    }
...
DEFINE_FUNCTION (ShowLookupTableRecWords, show_lookup_table_rec_words)
DEFINE_FUNCTION (HideLookupTableRecWords, hide_lookup_table_rec_words)
DEFINE_FUNCTION (ShowLookupTableRecSentences, show_lookup_table_rec_sentences)
DEFINE_FUNCTION (HideLookupTableRecSentences, hide_lookup_table_rec_sentences)
...
// David
static void
_context_update_focused_area_indicator_cb (BusInputContext  *context,
                                           guint            indicator,
                                           BusPanelProxy    *panel)
{
    g_assert (BUS_IS_INPUT_CONTEXT (context));
    ...
    bus_panel_proxy_update_focused_area_indicator(panel,
                                                  indicator);
}
...
static void
_context_update_lookup_table_rec_words_cb (BusInputContext *context,
                                 IBusLookupTable *table,
                                 gboolean         visible,
                                 BusPanelProxy   *panel)
{
    ...
    bus_panel_proxy_update_lookup_table_rec_words (panel,
                                         table,
                                         visible);
}

static void
_context_update_lookup_table_rec_sentences_cb (BusInputContext *context,
                                 IBusLookupTable *table,
                                 gboolean         visible,
                                 BusPanelProxy   *panel)
{
    ...
    bus_panel_proxy_update_lookup_table_rec_sentences (panel,
                                         table,
                                         visible);
}
...
DEFINE_FUNCTION (show_lookup_table_rec_words)
DEFINE_FUNCTION (hide_lookup_table_rec_words)
DEFINE_FUNCTION (show_lookup_table_rec_sentences)
DEFINE_FUNCTION (hide_lookup_table_rec_sentences)
...
static const struct {
    ...
    { "update-lookup-table-rec-words",              G_CALLBACK (_context_update_lookup_table_rec_words_cb) },
    { "update-lookup-table-rec-sentences",          G_CALLBACK (_context_update_lookup_table_rec_sentences_cb) },
    { "show-lookup-table",                          G_CALLBACK (_context_show_lookup_table_cb) },
    { "hide-lookup-table",                          G_CALLBACK (_context_hide_lookup_table_cb) },
    { "show-lookup-table-rec-words",                G_CALLBACK (_context_show_lookup_table_rec_words_cb) },
    { "hide-lookup-table-rec-words",                G_CALLBACK (_context_hide_lookup_table_rec_words_cb) },
    { "show-lookup-table-rec-sentences",            G_CALLBACK (_context_show_lookup_table_rec_sentences_cb) },
    { "hide-lookup-table-rec-sentences",            G_CALLBACK (_context_hide_lookup_table_rec_sentences_cb) },
    ...
    // David
    { "update-focused-area-indicator",              G_CALLBACK (_context_update_focused_area_indicator_cb) },
